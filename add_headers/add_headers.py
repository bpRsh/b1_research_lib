...
def add_headers():
    ...
    indir   = '/Users/poudel/Research/useful_scripts_lib/add_headers/'
    outdir  = '/Users/poudel/Research/useful_scripts_lib/add_headers/'
    infile  = indir + 'f814w_bulge'  + str(count) + '.fits'
    outfile = outdir + 'f814w_bulge_header' + str(count) + '.fits'
