...
def main():
    ...
    centroid_file = '/Users/poudel/Research/galfit_usage/expdisk_devauc_fitting/centroidsf6.csv'

    #  there are 302 galaxies for each filter (including 0 to 301)
    # for count in list(range(0, 302)):
    for count in range(0, 1):
        # run galfit
        run_galfit('f606w', galfit_outdir, count, centroid_file)
        # run_galfit('f814w', galfit_outdir, count, centroid_file)
